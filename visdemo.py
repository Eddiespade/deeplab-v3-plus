...
def main():
    ...
    parser.add_argument('--in-path', type=str, default='./datasets/test/images',
                        help='image to test')
    parser.add_argument('--out-path', type=str, default='./datasets/test/seg_result', help='mask image to save')
    parser.add_argument('--backbone', type=str, default='mobilenet',
                        choices=['resnet', 'xception', 'drn', 'mobilenet'],
                        help='backbone name (default: resnet)')
    parser.add_argument('--ckpt', type=str, default='./run/ceymo/deeplab-mobilenet/model_best.pth.tar',
                        help='saved model')
    ...
    parser.add_argument('--dataset', type=str, default='ceymo',
                        choices=['pascal', 'coco', 'cityscapes', 'ceymo'],
    ...
    for name in os.listdir(args.in_path):
        ...
        shutil.copyfile(args.in_path + "/" + name, args.out_path + "/" + name)
        u_time = time.time()
